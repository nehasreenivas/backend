...
def authenticate_user(username, password):
    ...
    user_data = convert_cursor(result)
    
    is_interviewer = user_data.get("interviewer", False)

    return {'userData': user_data, 'interviewer': is_interviewer, 'msg': 'login success'}, 200
